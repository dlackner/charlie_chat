  ...
  useEffect(() => {
    const fetchIntelligenceData = async () => {
      ...
      try {
        ...
        const response = await fetch(`/api/metrics/property-intelligence?${params.toString()}`);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl p-6 w-96 max-h-96 overflow-y-auto">
            ...
            <div className="space-y-3">
              ...
              <div className="pt-3 border-t">
                <a
                  href={`/discover/property/${selectedProperty.property_id}?back=${encodeURIComponent('/dashboard/pipeline')}`}
