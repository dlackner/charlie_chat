      ...
      <div className="bg-blue-600 py-20">
        <div className="max-w-4xl mx-auto px-8 md:px-12 text-center">
          ...
          <div className="text-xl text-white leading-relaxed space-y-6">
            ...
            <p>
              Through cutting-edge AI, machine learning automation, and community-sourced capital, we're empowering individual investors to analyze faster, fund smarter, and scale with institutional-grade confidence.
            </p>
          </div>
