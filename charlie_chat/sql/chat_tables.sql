/*
 * CHARLIE2 V2 - Chat Persistence Database Tables
 * Tables for storing chat threads and messages for AI Coach
 * Compatible with assistant-ui expected structure
...
-- Update trigger for threads updated_at
