...
<div className="mt-8 text-center">
    {hasAccess ? (
        <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white font-medium text-lg py-2 px-6 rounded-lg transition-colors duration-150 shadow-sm flex items-center mx-auto space-x-2 h-12"
        >
        ...
        <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
            <div className="flex items-center justify-center mb-3">
                ...
                <h3 className="text-lg font-semibold text-gray-700">Offer Analysis</h3>
            </div>
            ...
            <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-lg transition-colors duration-150 shadow-sm"
            >
                Upgrade to Access
            </button>
        </div>
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-6">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-bold text-gray-900">Offer Analysis</h2>
                                        <p className="text-sm text-gray-600">Comprehensive property assessment report</p>
                                    </div>
                                </div>
                                <button
                            ...
                            <div className="prose max-w-none">
                                {summary.split('\n').map((line, index) => {
                                    if (line.startsWith('## ')) {
                                        return <h2 key={index} className="text-xl font-bold text-blue-600 mt-4 mb-2 border-b border-gray-200 pb-2">{line.replace('## ', '')}</h2>;
                                    } else if (line.startsWith('**') && line.endsWith('**')) {
                            ...
                            <div className="flex flex-col sm:flex-row sm:space-x-3 space-y-2 sm:space-y-0 mt-6 pt-4 border-t border-gray-200">
                                ...
                                <button
                                    onClick={() => setShowSummary(false)}
                                    className="bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 px-5 rounded-lg transition-colors duration-150 flex items-center justify-center shadow-sm"
                                >
                                    Close
                                </button>
                            </div>
