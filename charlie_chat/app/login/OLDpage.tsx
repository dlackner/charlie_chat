/*
 * LEGACY LOGIN PAGE - NOT PART OF V2 SYSTEM
 * 
 * NOTE: This file can be deleted as it's not part of the new V2 system.
 * Login functionality has been moved to:
 * - Main landing page with signup/signin: /app/page.tsx (/)
 * - V2 loginnew page (backup): /app/v2/loginnew/page.tsx
 * 
 * This legacy login page at /login should be removed once we confirm
 * all authentication flows are working properly through the new system.
 */
"use client";
