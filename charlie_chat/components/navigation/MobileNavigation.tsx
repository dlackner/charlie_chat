...
const navigation = [
  ...
  { 
    ...
    submenu: [
      ...
      { name: 'Deal Pipeline', href: '/discover/pipeline' },
  ...
  { 
    ...
    icon: Users,
    submenu: [
      { name: 'Outreach', href: '/engage/outreach' },
      { name: 'Email Campaigns', href: '/engage/campaigns' },
      { name: 'Skip Trace', href: '/engage/skiptrace' },
      { name: 'Contact Management', href: '/engage/contacts' }
    ]
  },
  { 
    name: 'AI CHAT', 
